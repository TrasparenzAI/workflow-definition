...
Il blocco recuperato viene parcellizzato in base al parametro fornito in input **page_size** diviso per *10* e utilizzando il [TASK FORK/JOIN](https://orkes.io/content/reference-docs/operators/fork-join) vengono eseguiti in parallello *10* flussi [Rule Workflow](rule_workflow.json).        
